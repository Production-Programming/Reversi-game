...
socket.on('join_room_response', (payload) =>{
    ...
    let newString = '<p class=\'join_room_response\'>'+payload.username+' вошел в '+payload.room+'. (В зале ожидания находятся '+payload.count+' человек)</p>';
